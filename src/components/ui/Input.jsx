  ...
  return (
    <div className="space-y-2">
      ...
      <input
        ...
        className={`w-full rounded-xl border bg-surface px-4 py-2 text-ink outline-none transition placeholder:text-stone-400 disabled:cursor-not-allowed disabled:bg-stone-100 disabled:text-stone-400 ${
          error
